...
export function PrivacyPolicy() {
  return <main className="sw-app es-page"><article className="es-content">
    ...
    <ul>
      ...
      <li><strong>Practice questions:</strong> opening Practice or requesting another question sends one of your saved keywords and its explanation through our Vercel backend to DeepSeek. The question, selected answer, and answered count remain in the current workspace session and are not saved to the database.</li>
    ...
    <p>Vercel hosts the roadmap and practice APIs, which verify your Supabase sign-in before requesting content from DeepSeek. Your account password is not sent to DeepSeek. The plan generator sends your questionnaire answers and selected career information; practice sends the selected saved keyword and explanation.</p>
